...
class TreeController implements ControllerProviderInterface
{
    public function connect(Application $app)
    {
        ...
        $controllers->get('{repo}/tree/{branch}/{tree}/', $treeController = function($repo, $branch = '', $tree = '') use ($app) {
        ...
        $controllers->get('{repo}/{branch}/', function($repo, $branch) use ($app, $treeController) {
            return $treeController($repo, $branch);
        })->assert('repo', '[\w-._]+')
          ->assert('branch', '[\w-._]+')
          ->bind('branch');

        $controllers->get('{repo}/', function($repo) use ($app, $treeController) {

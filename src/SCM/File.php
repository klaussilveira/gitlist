...
class File
{
    ...
    public const BINARY_MIME_TYPES = [
    ...
    {
        return str_starts_with($this->mimeType, 'model');
    }

    public function isBinary(): bool
    {
        return in_array($this->mimeType, self::BINARY_MIME_TYPES);
    }
    ...
    {
        return new Language($this->extension);
    }
}
